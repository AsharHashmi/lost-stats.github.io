...
Below is a small example of a dataset for illustration.
...
The example below uses `statsmodels`' MICE implementation. It creates the artificial dataset directly in code, imputes the missing values, estimates a wage regression, and pools the results.
